...
10. 10. [Lists showing no results while their data sources were full](cases/10-empty-lists-from-cloned-app-config.md) — configuration inherited through an app clone, filtering on a column that no longer existed; a user-reported reproduction that turned out to be a coincidence
